...
| dcos\_version | Specifies which DC/OS version instruction to use. Options: 1.13.4, 1.12.4, 1.11.11, etc. See dcos_download_path or dcos_version tree for a full list. | string | `"1.11.4"` | no |
